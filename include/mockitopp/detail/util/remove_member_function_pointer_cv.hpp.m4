...
define(`REMOVE_MFP_CONST_TEMPLATE',
...
')dnl
M4_REPEAT(eval(MOCKITOPP_MAX_VIRTUAL_FUNCTION_ARITY + 1), `REMOVE_MFP_CONST_TEMPLATE')dnl
define(`REMOVE_MFP_CONST_VOLATILE_TEMPLATE',
...
')dnl
M4_REPEAT(eval(MOCKITOPP_MAX_VIRTUAL_FUNCTION_ARITY + 1), `REMOVE_MFP_CONST_VOLATILE_TEMPLATE')dnl
   } // namespace detail
} // namespace mockitopp
